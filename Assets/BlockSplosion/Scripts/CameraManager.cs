...
public class CameraManager : MonoBehaviour
{
	...
	[SerializeField]
	private OVRCameraController	_controller;

	[SerializeField]
	private GameObject _tracking;

	[SerializeField]
	private bool _allowEyeHeightScale = false;
	...
	private Vector3 _initialEyePos;
	...
	public float CameraScale
	{
		...
		set
		{
			...
			{
				_cameraScale = value;
				if (_allowEyeHeightScale)
					_controller.EyeCenterPosition = (_initialEyePos*_cameraScale);
				_controller.SetIPD(_initialIPD*_cameraScale);
			}
		}
	}
